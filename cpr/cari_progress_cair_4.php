<TITLE>PENDING TAHAP DOKUMEN</TITLE>
<style type="text/css">
<!--
.style1 {
...
<p><span class="style1"><a href="summary.php">MENU UTAMA</a>&nbsp&nbsp&nbsp<a href="laporan.htm" class="style1">LAPORAN</a>&nbsp&nbsp&nbsp</span> <BR>
  <BR>
  <style type="text/css">
table { 
...
<form method=get action=cari_progress_cair_4.php>
  ...
  <p class="style11">  <INPUT type=radio name=pilih value=tgl_cair_4  checked> 
  Tahap Dokumen <br>
  <br>
...
if($pilih == "tgl_cair_1")
{
$a = "DAFTAR DEBITUR PENDING TAHAP PONDASI";
}
elseif($pilih == "tgl_cair_2")
{
$a = "DAFTAR DEBITUR PENDING TAHAP TOPPING OFF";
}
elseif($pilih == "tgl_cair_3")
{
$a = "DAFTAR DEBITUR PENDING TAHAP BAST";
}
elseif($pilih == "tgl_cair_4")
{
$a = "DAFTAR DEBITUR PENDING TAHAP DOKUMEN";
}

$tampil=mysql_query("SELECT * FROM data WHERE data.lnc LIKE '$lnc' AND data.tgl_cair_1 >'0000-00-00' AND data.tgl_cair_2 >'0000-00-00' AND data.tgl_cair_3 >'0000-00-00' AND $pilih ='0000-00-00' AND data.progress='BELUM'    
                    ORDER BY data.tgl_pk ASC");
$jumlah= mysql_num_rows($tampil);

//ngitung jumlah 
$max    = "SELECT SUM(max_kredit) AS total_max FROM data WHERE data.progress='BELUM' AND data.lnc LIKE '$lnc' AND $pilih='0000-00-00' AND data.tgl_cair_1 > '0000-00-00' AND data.tgl_cair_2 >'0000-00-00' AND data.tgl_cair_3 >'0000-00-00' ";
$result = mysql_query($max) or die 
         (mysql_error());
  $t    = mysql_fetch_array($result);
$xxx    = $t['total_max'];

$cair1  = "SELECT SUM(cair_1) AS total_max FROM data WHERE data.progress='BELUM' AND data.lnc LIKE '$lnc' AND $pilih='0000-00-00' AND data.tgl_cair_1 > '0000-00-00' AND data.tgl_cair_2 >'0000-00-00' AND data.tgl_cair_3 >'0000-00-00' ";
$result = mysql_query($cair1) or die 
         (mysql_error());
  $t    = mysql_fetch_array($result);
$xxx1   = $t['total_max'];

$cair2  = "SELECT SUM(cair_2) AS total_max FROM data WHERE data.progress='BELUM' AND data.lnc LIKE '$lnc' AND $pilih='0000-00-00' AND data.tgl_cair_1 > '0000-00-00' AND data.tgl_cair_2 >'0000-00-00' AND data.tgl_cair_3 >'0000-00-00' ";
$result = mysql_query($cair2) or die 
         (mysql_error());
  $t    = mysql_fetch_array($result);
$xxx2   = $t['total_max'];

$cair3  = "SELECT SUM(cair_3) AS total_max FROM data WHERE data.progress='BELUM' AND data.lnc LIKE '$lnc' AND $pilih='0000-00-00' AND data.tgl_cair_1 > '0000-00-00' AND data.tgl_cair_2 >'0000-00-00' AND data.tgl_cair_3 >'0000-00-00' ";
$result = mysql_query($cair3) or die 
         (mysql_error());
  $t    = mysql_fetch_array($result);
$xxx3   = $t['total_max'];

$cair4  = "SELECT SUM(cair_4) AS total_max FROM data WHERE data.progress='BELUM' AND data.lnc LIKE '$lnc' AND $pilih='0000-00-00' AND data.tgl_cair_1 > '0000-00-00' AND data.tgl_cair_2 >'0000-00-00' AND data.tgl_cair_3 >'0000-00-00' ";
...
$tampil2    = mysql_query("SELECT * FROM data WHERE data.progress='BELUM' AND data.lnc LIKE '$lnc' AND $pilih='0000-00-00' AND data.tgl_cair_1 > '0000-00-00' AND data.tgl_cair_2 >'0000-00-00' AND data.tgl_cair_3 >'0000-00-00'  ");
