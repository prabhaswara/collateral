...
<p><span class="style1"><a href="summary_bso.php">MENU UTAMA</a>&nbsp&nbsp&nbsp<a href="kpi_bso.htm" class="style1">LAPORAN</a>&nbsp&nbsp&nbsp</span> <BR>
  <BR>
  <style type="text/css">
table { 
...
<form name=biodata method=get action=cari_progress_bso.php>
  <p class="style2"><span class="style2">
    <font face="Arial">    </font> </span>  </p>
  <p class="style11"> <INPUT type=radio name=pilih value=status checked>
  MONITORING BDO<span class="style2"><font face="Arial">
  <select size="1" name="cari" value="">
    <option>= SELECT =</option>
    <option>CLEAN</option>
    <option>TIDAK</option>
  </select>
  </font></span> 
  <p class="style11">PERIODE
:  
...
$tampil=mysql_query("SELECT * FROM bdo WHERE $pilih LIKE '$cari' AND bdo.tgl_buku between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]'
                    ORDER BY bdo.tgl_buku ASC");
$jumlah= mysql_num_rows($tampil);

//ngitung jumlah 
$max    = "SELECT SUM(max_kredit) AS total_max FROM data WHERE $pilih LIKE '$cari' AND data.tgl_pk between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ";
$result = mysql_query($max) or die 
         (mysql_error());
  $t    = mysql_fetch_array($result);
$xxx    = $t['total_max'];

$cair1  = "SELECT SUM(cair_1) AS total_max FROM data WHERE $pilih LIKE '$cari' AND data.tgl_pk between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]'";
$result = mysql_query($cair1) or die 
         (mysql_error());
  $t    = mysql_fetch_array($result);
$xxx1   = $t['total_max'];

$cair2  = "SELECT SUM(cair_2) AS total_max FROM data WHERE $pilih LIKE '$cari' AND data.tgl_pk between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]'";
$result = mysql_query($cair2) or die 
         (mysql_error());
  $t    = mysql_fetch_array($result);
$xxx2   = $t['total_max'];

$cair3  = "SELECT SUM(cair_3) AS total_max FROM data WHERE $pilih LIKE '$cari' AND data.tgl_pk between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]'";
$result = mysql_query($cair3) or die 
         (mysql_error());
  $t    = mysql_fetch_array($result);
$xxx3   = $t['total_max'];

$cair4  = "SELECT SUM(cair_4) AS total_max FROM data WHERE $pilih LIKE '$cari' AND data.tgl_pk between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]'";
...
<th widht=30>GOLONGAN</th>
<th>PERSETUJUAN</th>
<th>HUTANG POKOK</th>
<th>TGK. HUTANG POKOK</th>
<th>TGK. BUNGA</th>
<th width=50>TGK. DENDA</th>
<th width=50>TGK. BIAYA</th>
<th width=50>OUTSTANDING</th>
<th width=50>HAPUS TAGIH</th>
<th width=50>HT POKOK & BIAYA</th>
<th width=50>NOMINAL BUKU</th>
<th width=50>TGL. BUKU</th>
...
<td td align='center'><font color='blue'><b>$r[nama_debitur]</td>
<td align='left'><font color='blue'><b>$r[no_rekg]</td>
<td align='right'><font color='blue'><b>$r[golongan]</td>
<td align='center'><font color='blue'><b>$r[persetujuan]</td>
<td align='center'><font color='blue'><b>$r[hp]</td>
<td align='center'><font color='blue'><b>$r[tgk_hp]</td>
<td align='center'><font color='blue'><b>$r[tgk_bunga]</td>
<td align='right'><font color='blue'><b>$r[tgk_denda]</td>
<td align='center'><font color='blue'><b>$r[tgl_biaya]</td>
<td align='right'><font color='blue'><b>$r[outs]</td>
<td align='center'><font color='blue'><b>$r[ht]</td>
<td align='right'><font color='blue'><b>$r[ada_ht]</td>
<td align='center'><font color='blue'><b>$r[voucher]</td>
<td align='right'><font color='blue'><b>$r[tgl_buku]</td>
<td align='center'><font color='blue'><b>$selisih</td>
<td align='center'><font color='blue'><b><BLINK>$r[status]</td>
<td align='center'><a href=edit_data_debitur_bdo.php?id=$r[rekg_pinjaman]>Edit
</td>
</tr>";
      $no++;
}
...
$tampil2    = mysql_query("SELECT * FROM data WHERE $pilih LIKE '%$cari%' AND data.tgl_pk between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ");
