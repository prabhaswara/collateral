...
<form method=get action=cari_cair_bso.php>
  <p class="style2">&nbsp;</p>
...
if($pilih == "produk")
{
$a = "DAFTAR EVALUASI PENCAIRAN TAHAP I";
}
...
$tampil=mysql_query("SELECT * FROM data WHERE lnc='$lnc' AND cek_1=''");
...
<th width=50>HARI CAIR TAHAP PONDASI</th>
<th width=50>STATUS TAHAP PONDASI</th>
...
<td align='center'><a href=edit_data_1.php?id=$r[rekg_pinjaman]>Edit
</td>
</tr>";
      $no++;
}
