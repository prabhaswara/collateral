...
<form name=biodata method=get action=lihat_lunas.php>
  <p class="style11">
    <INPUT type=radio name=pilih value=status_rekg checked>
  REKENING LUNAS PER PERIODE<br>
  </p>
...
$tampil=mysql_query("SELECT * FROM debitur WHERE $pilih='LUNAS' AND LNC='$lnc' AND debitur.tgl_pelunasan between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ORDER BY tgl_pelunasan ASC");
...
$allx  = "SELECT SUM(maksimum_kredit) AS total_max FROM debitur WHERE $pilih='LUNAS' AND LNC='$lnc' AND debitur.tgl_pelunasan between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ORDER BY debitur.tgl_pelunasan DESC ";
...
<td align='center'><font color='red'><blink><b>$r[tgl_pelunasan]</td>
...
<td align='center'><font color='blue'><b>$r[tgl_pelunasan]</td>
<td align='center'><a href=edit_data_debitur.php?id=$r[NOAPLIKASI]>Edit
</tr>";
      $no++;
}
...
<td align='center'><b>$r[tgl_pelunasan]</td>
<td align='center'><a href=edit_data_debitur.php?id=$r[NOAPLIKASI]>Edit
