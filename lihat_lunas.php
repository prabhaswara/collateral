...
$tampil=mysql_query("SELECT * FROM debitur WHERE $pilih='LUNAS' ".(($lnc=="all")?"":"AND LNC='$lnc'")." AND debitur.tgl_pelunasan between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ORDER BY tgl_pelunasan ASC");
...
$allx  = "SELECT SUM(maksimum_kredit) AS total_max FROM debitur WHERE $pilih='LUNAS' ".(($lnc=="all")?"":"AND LNC='$lnc'")." AND debitur.tgl_pelunasan between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ORDER BY debitur.tgl_pelunasan DESC ";
