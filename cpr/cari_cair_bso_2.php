...
<form method=get action=cari_cair_bso_2.php>
  <p class="style2">&nbsp;</p>
...
if($pilih == "produk")
{
$a = "DAFTAR EVALUASI PENCAIRAN TAHAP II";
}
...
$tampil=mysql_query("SELECT * FROM data WHERE lnc='$lnc' AND cek_2=''");
...
<th width=50>TGL. CAIR TAHAP 2</th>
<th width=50>HARI CAIR TAHAP 2</th>
<th width=50>STATUS TAHAP 2</th>
...
<td align='center'><a href=edit_data_2.php?id=$r[rekg_pinjaman]>Edit
</td>
</tr>";
      $no++;
}
