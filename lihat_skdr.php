...
<form name=biodata method=get action=lihat_skdr.php>
  <p class="style11">
    <INPUT type=radio name=pilih value=skdr checked>
  PINJAMAN YANG DIAJUKAN SKDR PER PERIODE<br>
  </p>
...
if($pilih == "skdr")
{
$a = "PINJAMAN YANG DIAJUKAN SKDR PER PERIODE";
}
...
$tampil=mysql_query("SELECT * FROM debitur WHERE $pilih='YA' AND LNC='$lnc' AND debitur.tgl_pk between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ORDER BY tgl_pk ASC");
...
$allx  = "SELECT SUM(maksimum_kredit) AS total_max FROM debitur WHERE $pilih='ya' AND LNC='$lnc' AND debitur.tgl_pk between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ORDER BY debitur.tgl_pk DESC ";
...
<td align='center'><font color='red'><b>$r[memo]</td>
...
<td align='center'><font color='blue'><b>$r[memo]</td>
<td align='center'><a href=edit_data_debitur.php?id=$r[NOAPLIKASI]>Edit
</tr>";
      $no++;
}
