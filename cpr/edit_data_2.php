...
echo "<h2 ALIGN='CENTER'>EDIT HASIL VERIFIKASI BSO PENCAIRAN TAHAP II</h2>
<form id=postform name=biodata method=POST action=update_data_2.php>
...
<tr><td>CEK BSO TAHAP II</td><td> :
<select size='1' name='cek_2'>
          <option>- Pilih -</option>
          <option>CLEAN</option>
          <option>TIDAK</option>

<tr><td>HASIL EVALUASI BSO</td><td> :
<input type=text colour=red name=keterangan_bso_2 size=100 background-color: #FFFF33; layer-background-color: #FFFF33; border: 1px none #FFFF33; value='$r[keterangan_bso_2]'> 
