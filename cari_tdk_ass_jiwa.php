...
$tampil= mysql_query("SELECT * FROM debitur WHERE $pilih LIKE '%$cari%' AND debitur.no_polis_ass_jiwa = 'TIDAK' AND LNC='$lnc' ORDER BY debitur.tgl_pk LIMIT $posisi,$batas");
...
//Langkah 3
$tampil2    = "SELECT * FROM debitur WHERE $pilih LIKE '%$cari%' AND debitur.no_polis_ass_jiwa = 'TIDAK' AND LNC='$lnc'";
