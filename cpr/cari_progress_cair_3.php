<TITLE>PENDING TAHAP BAST</TITLE>
<style type="text/css">
<!--
.style1 {
...
<form method=get action=cari_progress_cair_3.php>
...
$tampil=mysql_query("SELECT * FROM data WHERE data.lnc LIKE '$lnc' AND data.tgl_cair_1 >'0000-00-00' AND data.tgl_cair_2 >'0000-00-00' AND $pilih ='0000-00-00' AND data.progress='BELUM'    
...
$tampil2    = mysql_query("SELECT * FROM data WHERE data.progress='BELUM' AND data.lnc LIKE '$lnc' AND $pilih='0000-00-00' AND data.tgl_cair_1 > '0000-00-00' AND data.tgl_cair_2 >'0000-00-00' ");
