...
<form name=biodata method=get action=cari_progress.php>
  ...
  STATUS PENCAIRAN BERTAHAP <span class="style2"><font face="Arial">
...
if($pilih == "progress")
{
$a = "STATUS PENCAIRAN BERTAHAP PER PERIODE TGL. PK";
}
...
$tampil=mysql_query("SELECT * FROM data WHERE $pilih LIKE '$cari' AND data.tgl_pk between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]'
