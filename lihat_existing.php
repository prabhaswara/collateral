...
<p><a href="produktifitas.htm" class="style1">PRODUKTIFITAS</a> <BR>
  <BR>
  <style type="text/css">
table { 
...
<form name=biodata method=get action=lihat_existing.php>
  <p class="style11">
...
$tampil=mysql_query("SELECT * FROM debitur WHERE $pilih='AKTIF' AND LNC='$lnc' AND debitur.tgl_update between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ORDER BY debitur.tgl_update ASC");
...
$allx  = "SELECT SUM(maksimum_kredit) AS total_max FROM debitur WHERE $pilih='AKTIF' AND LNC='$lnc' AND debitur.tgl_update between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ORDER BY debitur.tgl_update DESC ";
...
$tampil2    = mysql_query("SELECT * FROM debitur WHERE $pilih LIKE 'AKTIF' AND LNC LIKE '$lnc' AND debitur.tgl_update between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ORDER BY tgl_update DESC ");
