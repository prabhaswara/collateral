...
<p><span class="style1"><a href="produktifitas.htm" class="style1">PRODUKTIFITAS</a></span> <BR>
  <BR>
  <style type="text/css">
table { 
...
<form name=biodata method=get action=lihat_input.php>
  <p class="style11">
...
$tampil=mysql_query("SELECT * FROM debitur WHERE $pilih='AKTIF' AND LNC='$lnc' AND debitur.action between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ORDER BY debitur.action ASC");
...
<th width=65>NO. BPKB</th>
<th width=65>NO. SHT</th>
<th width=65>NO. POLIS JW</th>
<th width=65>NO. POLIS KERUGIAN</th>
<th width=65>TGL. INPUT</th>
...
$allx  = "SELECT SUM(maksimum_kredit) AS total_max FROM debitur WHERE $pilih='AKTIF' AND LNC='$lnc' AND debitur.action between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ORDER BY debitur.action DESC ";
...
$tampil2    = mysql_query("SELECT * FROM debitur WHERE $pilih LIKE 'AKTIF' AND LNC LIKE '$lnc' AND debitur.action between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ORDER BY action DESC ");
