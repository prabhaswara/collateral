...
<form method=get action=cari_progress_cair.php>
  ...
  Tahap I <br>
  <INPUT type=radio name=pilih value=tgl_cair_2> 
  Tahap II <br>
  <INPUT type=radio name=pilih value=tgl_cair_3> 
  Tahap III  <br>
  <INPUT type=radio name=pilih value=tgl_cair_4> 
  Tahap IV
  </p>
  <p class="style2">
...
$tampil=mysql_query("SELECT * FROM data WHERE data.lnc LIKE '$lnc' AND $pilih ='0000-00-00' AND data.progress='BELUM'   
...
<th>PERUMAHAN</th>
<th>ESCROW</th>
<th width=50>CAIR TAHAP I</th>
<th width=50>TGL. CAIR TAHAP 1</th>
<th width=50>CAIR TAHAP II</th>
<th width=50>TGL. CAIR TAHAP II</th>
<th width=50>CAIR TAHAP III</th>
<th width=50>TGL.CAIR TAHAP III</th>
<th width=50>CAIR TAHAP IV</th>
<th width=50>TGL. CAIR TAHAP IV</th>
