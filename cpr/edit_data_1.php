...
echo "<h2 ALIGN='CENTER'>EDIT HASIL VERIFIKASI BSO PENCAIRAN TAHAP I</h2>
<form id=postform name=biodata method=POST action=update_data_1.php>
...
<input type=text colour=red name=keterangan_bso_1 size=100 background-color: #FFFF33; layer-background-color: #FFFF33; border: 1px none #FFFF33; value='$r[keterangan_bso_1]'> 
