...
<p><span class="style1"><a href="summary_app.php">MENU UTAMA</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="menu_appraisal.htm" class="style1">MENU APPRAISAL</a></span> <BR>
  <BR>
  <style type="text/css">
table { 
...
<form name=biodata method=get action=lihat_input_app.php>
  <p class="style11">
  <INPUT type=radio name=pilih value=status_rekg checked>
  DAFTAR INPUT DATA DEBITUR PER PERIODE<br>
  </p>
...
{
$a = "DAFTAR INPUT DATA DEBITUR PER PERIODE";
}
...
$tampil=mysql_query("SELECT * FROM debitur WHERE debitur.produk<>'BNI Fleksi' AND debitur.produk<>'3610 0101 - BNI FLEKSI IND FLAT IDR' AND LNC='$lnc' AND debitur.action between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ORDER BY debitur.action ASC");
...
$allx  = "SELECT SUM(maksimum_kredit) AS total_max FROM debitur WHERE debitur.produk<>'BNI Fleksi' AND debitur.produk<>'3610 0101 - BNI FLEKSI IND FLAT IDR' AND LNC='$lnc' AND debitur.action between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ORDER BY debitur.action DESC ";
...
$tampil2    = mysql_query("SELECT * FROM debitur WHERE debitur.produk<>'BNI Fleksi' AND debitur.produk<>'3610 0101 - BNI FLEKSI IND FLAT IDR' AND LNC LIKE '$lnc' AND debitur.action between '$_GET[tgl_awal]' AND '$_GET[tgl_akhir]' ORDER BY action DESC ");
...
echo "<b><font color='blue'><p>TOTAL DEBITUR YANG DIINPUT : $jmldata DEBITUR</b> </font>";
