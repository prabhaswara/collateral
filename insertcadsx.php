<strong> <a href="summary.php">MENU UTAMA</a>&nbsp;&nbsp;&nbsp; <a href="form_cads.htm">INPUT CADS</a></strong><br><br><br>
...
$abc5=str_replace(".","",$_POST['nilai_pertanggungan_ass_jiwa']);
$abc6=str_replace(".","",$_POST['premi_jiwa']);
$abc7=str_replace(".","",$_POST['nilai_pertanggungan_ass_kerugian']);
$abc8=str_replace(".","",$_POST['premi_kerugian']);
