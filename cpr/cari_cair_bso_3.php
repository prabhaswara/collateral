<TITLE>EVALUASI  TAHAP III</TITLE>
<style type="text/css">
<!--
.style1 {
...
<form method=get action=cari_cair_bso_3.php>
  <p class="style2">&nbsp;</p>
...
if($pilih == "produk")
{
$a = "DAFTAR EVALUASI PENCAIRAN TAHAP III";
}
...
$tampil=mysql_query("SELECT * FROM data WHERE lnc='$lnc' AND cek_3=''");
...
<th width=50>HARI CAIR TAHAP 3</th>
<th width=50>STATUS TAHAP 3</th>
...
<td align='center'><a href=edit_data_3.php?id=$r[rekg_pinjaman]>Edit
</td>
</tr>";
      $no++;
}
