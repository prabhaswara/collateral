...
echo "<h2 ALIGN='CENTER'>EDIT HASIL VERIFIKASI BSO PENCAIRAN TAHAP III</h2>
<form id=postform name=biodata method=POST action=update_data_3.php>
...
<tr><td>CEK BSO TAHAP III</td><td> :
<select size='1' name='cek_3'>
          <option>- Pilih -</option>
          <option>CLEAN</option>
          <option>TIDAK</option>

<tr><td>HASIL EVALUASI BSO</td><td> :
<input type=text colour=red name=keterangan_bso_3 size=100 background-color: #FFFF33; layer-background-color: #FFFF33; border: 1px none #FFFF33; value='$r[keterangan_bso_3]'> 
