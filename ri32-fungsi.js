...
function ri32() 
{
	ttm = document.getElementById( 'postform' ).elements['plafond_dimohon'].value;
	strtt= ttm.toString();
	kttm = kurensi(strtt);
	
	document.getElementById( 'postform' ).elements['plafond_dimohon'].value = kttm;
	...
	ttm5 = document.getElementById( 'postform' ).elements['maksimum_kredit'].value;
	strtt5= ttm5.toString();
	kttm5 = kurensi(strtt5);
	
	document.getElementById( 'postform' ).elements['maksimum_kredit'].value = kttm5;
