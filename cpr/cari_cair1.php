...
$tampil=mysql_query("SELECT * FROM data WHERE LNC='$lnc' AND data.progress='BELUM'  
...
echo "<p>TOTAL DATA <b>$a dari LNC $lnc</b> : <b>$jmldata</b> DEBITUR, SISA SALDO : Rp. $xxxy</p> ";
}
else{
